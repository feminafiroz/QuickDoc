...
const adminRepositoryMongodb = () => {
    const banners = (...args_1) => __awaiter(void 0, [...args_1], void 0, function* (filter = {}) { return yield Banner_1.default.find(filter); });
    const allBanners = () => __awaiter(void 0, void 0, void 0, function* () { return yield Banner_1.default.find(); });
