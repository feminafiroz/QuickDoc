...
function adminDbRepository(repository) {
    const banners = (...args_1) => __awaiter(this, [...args_1], void 0, function* (filter = {}) { return yield repository.banners(filter); });
    const allBanners = () => __awaiter(this, void 0, void 0, function* () { return yield repository.allBanners(); });
