          ...
          <div className="w-96 p-8 bg-gray-100 bg-opacity-50 rounded-lg shadow-lg ml-8">
            ...
            <form onSubmit={formik.handleSubmit}>
              ...
              <div className="mb-4">
               ...
               <div className="mb-4">
  <label htmlFor="password" className="block text-gray-700 mr-60">Password:</label>
...
<div className="mb-6">
  <label htmlFor="confirmPassword" className="block text-gray-700 mr-44">Confirm Password:</label>
  <div className="relative">
    <input
