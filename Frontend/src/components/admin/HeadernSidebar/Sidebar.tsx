...
// import { Utensils, Images, ListPlus, Star, Megaphone } from "lucide-react";
// import { Utensils, Images, ListPlus, Star, Megaphone, CheckCircle } from "lucide-react";
import {
  Star,
  Megaphone,
  Stethoscope,
      ...
      <ul className="space-y-2 font-medium">
        ...
        <li>
          <Link
            ...
            className="flex items-center p-4 text-white-900 rounded-lg dark:text-white hover:text-black hover:bg-gray-100 dark:hover:bg-gray-700 group"
          >
            <Megaphone className="flex-shrink-0 w-6 h-6 text-white-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" />
        ...
        <li>
          <Link
            ...
            className="flex items-center p-4 text-white-900 rounded-lg dark:text-white hover:text-black hover:bg-gray-100 dark:hover:bg-gray-700 group"
          >
            <Star className="flex-shrink-0 w-6 h-6 text-white-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" />
